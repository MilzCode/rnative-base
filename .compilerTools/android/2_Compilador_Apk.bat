...
java -jar %BUNDLETOOL_JAR% build-apks --bundle=%AAB_FILE% --output=%APK_FILE% --ks=%KEYSTORE_FILE% --ks-pass=pass:%KEYSTORE_PASS% --ks-key-alias=%KEY_ALIAS% --key-pass=pass:%KEY_PASS%
